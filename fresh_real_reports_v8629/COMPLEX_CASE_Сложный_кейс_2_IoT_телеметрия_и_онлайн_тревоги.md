...
| Средний | У зависимости есть лимиты запросов. | Затронуто мест: 2 | Добавьте клиентский лимиты запросовer, очередь выравнивания и увеличение паузы между повторами со случайным разбросом. |
...
|---|---|---|---|---|
| аналитическое хранилище и витрины | Блокирует выпуск | аналитическое хранилище не должен находиться в основной поток. | аналитическое хранилище обычно не рассчитаноо на операционный целевое время ответа. | Выгружайте через CDC/ETL после фиксации операции. |
