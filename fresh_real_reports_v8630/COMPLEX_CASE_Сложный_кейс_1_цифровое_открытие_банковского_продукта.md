...
| Высокий | аналитическое хранилище или аналитика находятся в операционном основном потоке. | Шаг 18 «Аналитическое хранилище хранит согласованные витрины» → аналитическое хранилище | Сделайте шаг non-blocking: используйте CDC, ETL или событие после фиксации результата в операционной системе. |
...
Матрица деталей: применимо инвариантов из каталога v7.1 — 124 из 125; блокируют выпуск — 11, требуют внимания — 30, нужно уточнить — 42, уже выглядит закрытым — 56.

| Область | Статус | Что проверить | Почему важно | Как закрыть |
|---|---|---|---|---|
| аналитическое хранилище и витрины | Блокирует выпуск | аналитическое хранилище не должен находиться в основной поток. | аналитическое хранилище обычно не рассчитанооо на операционный целевое время ответа. | Выгружайте через CDC/ETL после фиксации операции. |
