...
| 12 | Data Warehouse → Data Warehouse | Аналитические модели собирают витрины | данные доставлены в аналитический контур, полнота загрузки подтверждается сверкой |
