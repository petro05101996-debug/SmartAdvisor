...
FORBIDDEN_GLOBS = (
    'USER_FRIENDLY_VERIFY_*.json', 'SAAS_UI_VERIFY_*.json', 'UI_BROWSER_SMOKE_*.json', 'COMPLETE_UIUX_VERIFY_*.json', 'TRAINER_MAX_UX_VERIFY_*.json', 'COMPLEX_CASE_*.json', 'AUDIT_REPORT*.md', 'LANGUAGE_STYLE_*',
