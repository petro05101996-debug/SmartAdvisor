#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Release gate for SmartAdvisor v8.6.67.
...
FORBIDDEN_GLOBS = (
    'USER_FRIENDLY_VERIFY_*.json', 'SAAS_UI_VERIFY_*.json', 'UI_BROWSER_SMOKE_*.json', 'COMPLETE_UIUX_VERIFY_*.json', 'TRAINER_MAX_UX_VERIFY_*.json', 'COMPLEX_CASE_*.json', 'COMPLEX_CASE_*.md', 'AUDIT_REPORT*.md', 'LANGUAGE_STYLE_*',
