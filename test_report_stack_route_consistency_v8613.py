...
def test_report_does_not_confuse_service_db_with_main_transport():
    ...
    assert 'Шаг 3' in md and 'Основной способ взаимодействия: Обратный вызов' in md
    assert 'Шаг 4' in md and 'Основной способ взаимодействия: Аналитическое хранилище' in md
