...
@pytest.mark.skipif(os.environ.get("RUN_BROWSER_PYTEST") != "1", reason="Browser pytest smoke is covered by verify_ui_full_v8643.py / verify_trainer_ux_v8657.py; set RUN_BROWSER_PYTEST=1 for local browser run.")
