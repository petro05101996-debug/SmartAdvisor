...
APP_VERSION = '8.6.56-polished-final'
...
function learnerId(){{
  let id=localStorage.getItem('sa_learning_learner_id');
  if(!id){{ id='learner_'+Math.random().toString(16).slice(2)+Date.now().toString(16); localStorage.setItem('sa_learning_learner_id', id); }}
  return id;
}}
