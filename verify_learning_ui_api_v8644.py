...
def live_check():
    ...
    try:
        ...
        assert 'Каталог учебных кейсов MVP' in home
        ...
        assert 'Проверить моё решение' in page and 'REFERENCE_PAYLOAD' in page
...
def browser_static_check():
    ...
    with sync_playwright() as p:
        ...
        for name, vp in [('desktop',{'width':1366,'height':900}),('tablet',{'width':768,'height':1024}),('mobile',{'width':390,'height':844})]:
            ...
            expect(page.get_by_text('Каталог учебных кейсов MVP')).to_be_visible()
