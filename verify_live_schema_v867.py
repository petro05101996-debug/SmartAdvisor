...
with sync_playwright() as p:
    ...
    expect(page.locator('#stackStagePanel')).to_contain_text('Стек сформирован')
    # v8.6.15+: единая схема процесса намеренно не показывает стек и технические детали.
    expect(page.locator('#processMap')).not_to_contain_text('Стек:')
    browser.close()
